...
import math
litrostotais = float((metrospintados / 6) * 1.1 )
...
latasmisturadas = int((litrostotais // 18) + (math.ceil((litrostotais % 18) / 3.6)))
latasmisturadaspreco = ((litrostotais // 18) * 80) + (math.ceil((litrostotais % 18) / 3.6) * 25)
# Saída de Dados
